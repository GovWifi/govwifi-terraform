...
#             "Effect": "Allow",
#             "Resource": [
#               "${aws_s3_bucket.canary_tests_bucket.arn}",
#               "${aws_s3_bucket.canary_tests_bucket.arn}/*"
#             ],
#             "Sid": "CanarytestsStoreLogsPolicy"
#         },
#         {
#             "Action": [
#                 "codecommit:GitPull"
...
#   name        = "govwifi-crossaccount-tools-run-canary-tests"
#   path        = "/"
#   description = "Allows AWS Tools account to run canary-tests"
#
#   policy = <<POLICY
# {
#     "Version": "2012-10-17",
...
#   name  = "govwifi-canary-tests-alert-lambda"
#
#   assume_role_policy = <<EOF
# {
#     "Version": "2012-10-17",
