resource "aws_cloudwatch_metric_alarm" "athena_cost_alarm" {
  ...
  alarm_description   = "Alerts if Athena scans > 100Gb of data in 24 hours, usually caused by not using WHERE clauses to refine data search, which can incur high costs, please refine your queries."
